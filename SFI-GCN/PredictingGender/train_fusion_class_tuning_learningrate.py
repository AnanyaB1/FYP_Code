...
decay_rate = 0.5
decay_step = 6
lrs = [0.0006, 0.0007, 0.0008, 0.0009]
num_folds = 5
batch_size = 5
...
data_dir = f'/data/ananya012/results/Gender/PostFinalReport/TuningRuns/Tuning_smaller_learningrate_2_' + str(current_datetime)
...
for lr in lrs:
    ...
    for fold in range(1, 6):
        ...
        print(f"Hidden Channel: {hidden_channels}, HC2: {hc2}, Bottleneck: {bottleneck}")
        print()
        ...
        #################### File Definitions ####################
        # save to lr_dir based on fold
        

        # predict_train_csv = lr_dir + '/predict_train.csv'
        ...
        # write best test prediction to csv
    ...
    overall_performance[cur_lr[1:]] = mean_accuracy
