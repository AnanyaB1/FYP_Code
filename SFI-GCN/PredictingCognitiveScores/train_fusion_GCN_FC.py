...
base_dir = f'/data/ananya012/results/GCN/{score_name}/FC/'
if not os.path.exists(base_dir):
    os.makedirs(base_dir)

data_dir = f'/data/ananya012/results/GCN/{score_name}/FC/GCN_FC-' + str(int(time.time()))
